...
namespace CPAS.API.Middleware
{
    public class JwtMiddleware
    {
        ...
        private async Task AttachUserToContext(HttpContext context, IMemberService memberService, string token)
        {
            try
            {
                ...
                context.Items["User"] = await memberService.GetMemberDetail(userId);
            }
            catch
            {
